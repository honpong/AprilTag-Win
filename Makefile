...
COR_SOURCES := $(addprefix $(d)/, packet.c mapbuffer.c timestamp.c plugins.c _cor.c dispatch.c debug.c)
...
FILTER_SOURCES := $(addprefix $(d)/, _filter.cpp filter.cpp model.cpp)
$(d)/_filter.so: CC := $(CXX)
