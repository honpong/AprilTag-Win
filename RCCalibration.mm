...
+ (void) saveCalibrationData: (corvis_device_parameters)params
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:data forKey:KEY_CALIBRATION_DATA];
...
{
    return [[NSUserDefaults standardUserDefaults] objectForKey:KEY_CALIBRATION_DATA];
}
