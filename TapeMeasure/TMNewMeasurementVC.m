...
statesetup setups[] =
{
    ...
    { ST_FIRSTCALIBRATION, ICON_YELLOW, false, true, false, false, false, true, true, "Start", false, "Calibrating", "Please move the device around very slowly to calibrate it. Slowly rotate the device to the left or right as you go.", false},
    ...
    { ST_MOREDATA, ICON_YELLOW, false, true, false, false, false, true, true, "Start", false, "Initializing", "I need more data before we can measure. Try slowly moving around, then come back to the starting point.", false },
    ...
    { ST_VISIONFAIL, ICON_RED, false, true, false, false, false, true, false, "Start", false, "Try again", "Sorry, I can't see well enough to measure right now. Are the lights on? Error code %04x.", false },
    ...
    { ST_SLOWDOWN, ICON_YELLOW, false, true, true, true, true, true, false, "Start", false, "Measuring", "Slow down. You'll get the most accurate measurements by moving slowly and smoothly.", false }
};
