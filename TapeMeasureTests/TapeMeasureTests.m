...
//  TapeMeasureTests
//
//  Created by Ben Hirashima on 12/5/12.
//  Copyright (c) 2012 RealityCap. All rights reserved.
//

#import "TapeMeasureTests.h"
#import "TMDistanceFormatter.h"

@implementation TapeMeasureTests
...
- (void)testDistanceFormatter
{
    ...
    expected = @"1/16\"";
    result = [TMDistanceFormatter formattedDistance:testValue withUnits:UnitsImperial withScale:UnitsScaleIN withFractional:YES];
    ...
    testValue = 0.330;
    expected = @"1' 1\"";
    result = [TMDistanceFormatter formattedDistance:testValue withUnits:UnitsImperial withScale:UnitsScaleFT withFractional:YES];
    STAssertTrue([result isEqualToString:expected], [NSString stringWithFormat:@"%f should be %@, got %@", testValue, expected, result]);
    ...
    testValue = 1.19;
    expected = @"1yd 10 7/8\"";
    result = [TMDistanceFormatter formattedDistance:testValue withUnits:UnitsImperial withScale:UnitsScaleYD withFractional:YES];
    STAssertTrue([result isEqualToString:expected], [NSString stringWithFormat:@"%f should be %@, got %@", testValue, expected, result]);
    ...
    result = [TMDistanceFormatter formattedDistance:testValue withUnits:UnitsImperial withScale:UnitsScaleMI withFractional:YES];
    STAssertTrue([result isEqualToString:expected], [NSString stringWithFormat:@"%f should be %@, got %@", testValue, expected, result]);
