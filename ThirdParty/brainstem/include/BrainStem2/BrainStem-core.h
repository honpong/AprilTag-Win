...
namespace Acroname {
    namespace BrainStem {
        ...
        public:
            ...
            Module(const uint8_t address);
            
            Module(const uint8_t address, bool bAutoNetworking);
        ...
        /// \return ::aErrTimeout - Request timed out without response.
        /// \return ::aErrConnection - No active link.
        /// \}
