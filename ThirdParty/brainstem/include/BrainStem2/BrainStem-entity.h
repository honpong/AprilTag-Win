...
namespace Acroname {
    namespace BrainStem {
        ...
        // MARK:  - App Class
        /////////////////////////////////////////////////////////////////////
        /// The AppClass is used to send a cmAPP packet to the BrainStem network.
        ...
        // MARK:  - RCServo Class
        /////////////////////////////////////////////////////////////////////
        /// The RCServoClass is the interface to servo entities on BrainStem modules.
...
//            aErr getRange(uint8_t* min, uint8_t* max, uint8_t* trim);
        ...
        // MARK:  - I2C Class
        /////////////////////////////////////////////////////////////////////
        /// The I2CClass is the interface the I2C busses on BrainStem modules.
        ...
        public:
            ...
            /// Get the upstream switch state for the USB upstream ports. Returns none,
            /// if no ports plugged in, port 0, if the mode is set correctly and a cable
            /// is plugged into port 0, and port 1 if the mode is set correctly and a cable
