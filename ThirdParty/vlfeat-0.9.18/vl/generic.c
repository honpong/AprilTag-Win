...
static void vl_destructor (void) ;

#pragma section(".CRT$XCU",read)
static void vl_constructor_(void) { vl_constructor(); atexit(vl_destructor); }
__declspec(allocate(".CRT$XCU")) void (*vl_constructor__)(void) = vl_constructor_;

#else
#warning No detected way to call vl_constructor() and vl_destructor() automatically
#endif /* VL_OS_WIN */
