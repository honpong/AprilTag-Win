...
function np_to_portrait(){
    ...
    np_backgrnd.size(window.innerWidth, np_scale*np_b_h * 4).rotate(0).scale(np_scale);
    ...
    np_4.move(np_offset + np_scale*np_b_w*0,np_scale*np_b_h*1).rotate(0).scale(np_scale);
    np_5.move(np_offset + np_scale*np_b_w*1,np_scale*np_b_h*1).rotate(0).scale(np_scale);
    np_6.move(np_offset + np_scale*np_b_w*2,np_scale*np_b_h*1).rotate(0).scale(np_scale);
    np_7.move(np_offset + np_scale*np_b_w*0,np_scale*np_b_h*2).rotate(0).scale(np_scale);
    np_8.move(np_offset + np_scale*np_b_w*1,np_scale*np_b_h*2).rotate(0).scale(np_scale);
    np_9.move(np_offset + np_scale*np_b_w*2,np_scale*np_b_h*2).rotate(0).scale(np_scale);
    np_0.move(np_offset + np_scale*np_b_w*1,np_scale*np_b_h*3).rotate(0).scale(np_scale);
    np_prd.move(np_offset + np_scale*np_b_w*0,np_scale*np_b_h*3).rotate(0).scale(np_scale);
    np_del.move(np_offset + np_scale*np_b_w*2,np_scale*np_b_h*3).rotate(0).scale(np_scale);
    np_ent.move(np_offset + np_scale*np_b_w*3,np_scale*np_b_h*2).rotate(0).scale(np_scale);
    np_unt.move(np_offset + np_scale*np_b_w*3,np_scale*np_b_h*0).rotate(0).scale(np_scale);
    np_oth.move(np_offset + np_scale*np_b_w*3,np_scale*np_b_h*1).rotate(0).scale(np_scale);
}
...
function np_to_portrait_upsidedown(){
    ...
    np_2.move(np_offset + np_scale*np_b_w*2,np_scale*np_b_h*3).rotate(180).scale(np_scale);
    np_3.move(np_offset + np_scale*np_b_w*1,np_scale*np_b_h*3).rotate(180).scale(np_scale);
    np_4.move(np_offset + np_scale*np_b_w*3,np_scale*np_b_h*2).rotate(180).scale(np_scale);
    np_5.move(np_offset + np_scale*np_b_w*2,np_scale*np_b_h*2).rotate(180).scale(np_scale);
    np_6.move(np_offset + np_scale*np_b_w*1,np_scale*np_b_h*2).rotate(180).scale(np_scale);
    np_7.move(np_offset + np_scale*np_b_w*3,np_scale*np_b_h*1).rotate(180).scale(np_scale);
    np_8.move(np_offset + np_scale*np_b_w*2,np_scale*np_b_h*1).rotate(180).scale(np_scale);
    np_9.move(np_offset + np_scale*np_b_w*1,np_scale*np_b_h*1).rotate(180).scale(np_scale);
    np_0.move(np_offset + np_scale*np_b_w*2,np_scale*np_b_h*0).rotate(180).scale(np_scale);
    np_prd.move(np_offset + np_scale*np_b_w*3,np_scale*np_b_h*0).rotate(180).scale(np_scale);
    np_del.move(np_offset + np_scale*np_b_w*1,np_scale*np_b_h*0).rotate(180).scale(np_scale);
    np_ent.move(np_offset + np_scale*np_b_w*0,np_scale*np_b_h*0).rotate(180).scale(np_scale);
    np_unt.move(np_offset + np_scale*np_b_w*0,np_scale*np_b_h*3).rotate(180).scale(np_scale);
    np_oth.move(np_offset + np_scale*np_b_w*0,np_scale*np_b_h*2).rotate(180).scale(np_scale);
}
...
function np_to_landscape_left(){
    ...
    np_svg.move(landscape_offset, 0);
