...
public class TrackerProxy implements SensorEventListener, IRealSenseSensorReceiver, ITrackerReceiver
{
    ...
    public native void configureCamera(int width_px, int height_px, float center_x_px, float center_y_px, float focal_length_x_px, float focal_length_y_px, int depth_width, int depth_height, float depth_center_x_px, float depth_center_y_px, float depth_fx, float depth_fy, float offsetX, float offsetY, float offsetZ, float skew, boolean fisheye, float fisheye_fov_radians);
