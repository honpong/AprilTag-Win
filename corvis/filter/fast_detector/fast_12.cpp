...
vector<xy> &fast_detector_12::detect(const unsigned char *im, const unsigned char *mask, int number_wanted, int bthresh)
{
...
fast_detector_12::fast_detector_12(const int x, const int y, const int s): xsize(x), ysize(y), stride(s)
{
