...
inline void CopyVector(TRWS::REAL_TRW* to, MRF::CostVal* from, int K)
{
    TRWS::REAL_TRW* to_finish = to + K;
    do
	{
	    *to ++ = *from ++;
	} while (to < to_finish);
...
inline void AddVector(TRWS::REAL_TRW* to, TRWS::REAL_TRW* from, int K)
{
    TRWS::REAL_TRW* to_finish = to + K;
    do
	{
...
inline TRWS::REAL_TRW SubtractMin(TRWS::REAL_TRW *D, int K)
{
    int k;
    TRWS::REAL_TRW delta;
...
inline TRWS::REAL_TRW UpdateMessageL1(TRWS::REAL_TRW* M, TRWS::REAL_TRW* Di_hat, int K, TRWS::REAL_TRW gamma, MRF::CostVal lambda, MRF::CostVal smoothMax)
{
    int k;
    TRWS::REAL_TRW delta;
...
inline TRWS::REAL_TRW UpdateMessageL2(TRWS::REAL_TRW* M, TRWS::REAL_TRW* Di_hat, int K, TRWS::REAL_TRW gamma, MRF::CostVal lambda, MRF::CostVal smoothMax, void *buf)
{
    TRWS::REAL_TRW* Di = (TRWS::REAL_TRW*) buf;
    int* parabolas = (int*) ((char*)buf + K*sizeof(TRWS::REAL_TRW));
...
inline TRWS::REAL_TRW UpdateMessageFIXED_MATRIX(TRWS::REAL_TRW* M, TRWS::REAL_TRW* Di_hat, int K, TRWS::REAL_TRW gamma, MRF::CostVal lambda, MRF::CostVal* V, void* buf)
{
    TRWS::REAL_TRW* Di = (TRWS::REAL_TRW*) buf;
    int ki, kj;
    TRWS::REAL_TRW delta;
    ...
    for (ki=0; ki<K; ki++)
	{
	    Di[ki] = (gamma*Di_hat[ki] - M[ki]) * (1/(TRWS::REAL_TRW)lambda);
	}
...
inline TRWS::REAL_TRW UpdateMessageGENERAL(TRWS::REAL_TRW* M, TRWS::REAL_TRW* Di_hat, int K, TRWS::REAL_TRW gamma, int dir, MRF::CostVal* V, void* buf)
{
    TRWS::REAL_TRW* Di = (TRWS::REAL_TRW*) buf;
    int ki, kj;
    TRWS::REAL_TRW delta;
...
inline TRWS::REAL_TRW UpdateMessageGENERAL(TRWS::REAL_TRW* M, TRWS::REAL_TRW* Di_hat, int K, TRWS::REAL_TRW gamma, TRWS::SmoothCostGeneralFn fn, int i, int j, void* buf)
{
    TRWS::REAL_TRW* Di = (TRWS::REAL_TRW*) buf;
    int ki, kj;
    TRWS::REAL_TRW delta;
...
void TRWS::initializeAlg()
{
    ...
    m_messageArraySizeInBytes = messageNum*sizeof(REAL_TRW);
    m_messages = new REAL_TRW[messageNum];
    memset(m_messages, 0, messageNum*sizeof(REAL_TRW));
...
void TRWS::optimize_GRID_L2(int nIterations)
{
    ...
    Di = new REAL_TRW[K];
    buf = new char[(2*K+1)*sizeof(int) + K*sizeof(REAL_TRW)];
