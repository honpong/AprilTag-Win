...
xy fast_detector_11::track(const Descriptor& descriptor, const tracker::image& image, float predx, float predy, float radius, int b)
{
    ...
    for(y = y1; y <= y2; y++) {
        ...
        float score = descriptor.distance(x, y, image);
...
template xy fast_detector_11::track<DESCRIPTOR>(const DESCRIPTOR& descriptor, const tracker::image& image, float predx, float predy, float radius, int b);
