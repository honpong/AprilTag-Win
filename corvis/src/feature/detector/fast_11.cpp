...
vector<xy> &fast_detector_11::detect(const unsigned char *im, const scaled_mask *mask, int number_wanted, int bthresh, int winx, int winy, int winwidth, int winheight)
{
...
void fast_detector_11::init(const int x, const int y, const int s, const int ps, const int phw)
{
    xsize = x;
    ysize = y;
    stride = s;
...
xy fast_detector_11::track(const Descriptor& descriptor, const tracker::image& image, float predx, float predy, float radius, int b)
{
    int x, y;
...
template xy fast_detector_11::track<patch_descriptor>(const patch_descriptor& descriptor, const tracker::image& image, float predx, float predy, float radius, int b);

#include "orb_descriptor.h"
template xy fast_detector_11::track<orb_descriptor>(const orb_descriptor& descriptor, const tracker::image& image, float predx, float predy, float radius, int b);
