...
class fast_detector_9 {
 ...
 public:
    ...
    xy track(const unsigned char *im1, const unsigned char *im2, int xcurrent, int ycurrent, float predx, float predy, float radius, int b);
    void init(const int xsize, const int ysize, const int stride, const int patch_stride, const int patch_win_half_width);
};
/*
