...
int main(int c, char **v)
{
    ...
    auto data_callback = [&enable_gui, &incremental_ate, &render_output, &display_reloc](world_state &ws, replay &rp, bool &first, struct benchmark_result &res, rc_Tracker *tracker, const rc_Data *data) {
