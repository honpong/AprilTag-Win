...
///BSP_SET_CLOCK(		DEFAULT_OSC0_KHZ, 		PLL_DESIRED_FREQ_KHZ, 	1, 1, DEFAULT_RTEMS_CSS_LOS_CLOCKS | DEV_CSS_SDIO, 	0,								APP_UPA_CLOCKS,	0, 				0); // Demo LRT
// BSP_SET_CLOCK(		DEFAULT_OSC_CLOCK_KHZ, 	APP_CLOCK_KHZ, 			1, 1, DEFAULT_RTEMS_CSS_LOS_CLOCKS, 				DEFAULT_RTEMS_MSS_LRT_CLOCKS, 	UPA_SHAVE_L2, 	0, 				0); // Demo LRT comment
BSP_SET_CLOCK(DEFAULT_OSC_CLOCK_KHZ, APP_CLOCK_KHZ, 1, 1, CSS_LOS_CLOCKS,
              MSS_CLOCKS, UPA_CLOCKS, SIPP_CLOCKS, 0);  // We
                                                        ///BSP_SET_CLOCK(		DEFAULT_OSC_CLOCK_KHZ,	APP_CLOCK_KHZ,			1, 1, DEFAULT_RTEMS_CSS_LOS_CLOCKS | 0x1000, 		0, 								0, 				0, 				0); // Demo LOS

// BSP_SET_L2C_CONFIG(1, DEFAULT_RTEMS_L2C_REPLACEMENT_POLICY,	DEFAULT_RTEMS_L2C_WAYS,			DEFAULT_RTEMS_L2C_MODE, 0, 0);		// Demo LRT commented
//BSP_SET_L2C_CONFIG(1, DEFAULT_RTEMS_L2C_REPLACEMENT_POLICY,	DEFAULT_RTEMS_L2C_WAYS,			L2C_MODE_WRITE_THROUGH, 0, 0);		// Demo LRT

BSP_SET_L2C_CONFIG(1, L2C_REPL_LRU, 0, L2C_MODE_WRITE_THROUGH, 0, NULL);
// was this
//   BSP_SET_L2C_CONFIG(0, L2C_REPL_LRU, 							0, 								L2C_MODE_COPY_BACK, 	0, NULL);	// We
///BSP_SET_L2C_CONFIG(1, DEFAULT_RTEMS_L2C_REPLACEMENT_POLICY,	DEFAULT_RTEMS_L2C_LOCKED_WAYS,	L2C_MODE_WRITE_THROUGH,	0, 0);		// Demo LOS
