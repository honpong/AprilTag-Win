...
int main(int c, char **v)
{
    ...
    uint64_t shutter_time_100_ns = 16667 * 1000; // TODO: these are all in nanoseconds on mac
        ...
        else
        {
            switch(header.type)
            {
                case packet_camera:
                {
                    ...
                    rc_Timestamp time_100_ns = (header.time + 16667) * 1000;
                ...
                {
                    rc_Timestamp time_100_ns = header.time * 1000;
