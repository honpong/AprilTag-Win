...
extern "C" void stereo_kp_matching_and_compare(ShavekpMatchingSettings *kpMatchingParams, u8* p_kp1, u8* p_kp2, u8 * patches1[] , u8 * patches2[], float * depths1, float * errors1)
{
