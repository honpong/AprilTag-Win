...
TEST(RotationVector, ExactJacobians)
{
    rotation_vector w(.1,.2,.3);
    m4 J = {
            { (f_t)0.9784844,  (f_t)0.15156822390846117, -(f_t)0.093873647747713900, 0},
            {-(f_t)0.1449480,  (f_t)0.98344961186632260,  (f_t)0.059349614974115006, 0},
            { (f_t)0.1038038, -(f_t)0.03948914921370206,  (f_t)0.991724805933161300, 0},
            {      0,               0,                         0,                    0},
    };
