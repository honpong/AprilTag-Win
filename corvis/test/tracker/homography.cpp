...
TEST(Homography, Factorize)
{
    ...
    m3 Re[4];
    Re[0] = {{ {0.704, 0, 0.710}, {0, 1, 0}, {-0.710, 0, 0.704} }};
    Re[1] = {{ {0.951, 0, 0.309}, {0, 1, 0}, {-0.309, 0, 0.951} }};
    Re[2] = {{ {0.704, 0, 0.710}, {0, 1, 0}, {-0.710, 0, 0.704} }};
    Re[3] = {{ {0.951, 0, 0.309}, {0, 1, 0}, {-0.309, 0, 0.951} }};

    v3 Te[4];
    Te[0] = v3( 0.760, 0,  0.471);
    Te[1] = v3(-0.894, 0,      0);
    Te[2] = v3(-0.760, 0, -0.471);
    Te[3] = v3( 0.894, 0,      0);

    v3 Ne[4];
    Ne[0] = v3( 0.851, 0,  0.525);
    Ne[1] = v3(-0.447, 0, -0.894);
    Ne[2] = v3(-0.851, 0, -0.525);
    Ne[3] = v3( 0.447, 0,  0.894);
