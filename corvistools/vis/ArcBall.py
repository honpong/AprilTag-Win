...
class ArcBallT:
	...
	def setBounds (self, dims):
 		# //Set new bounds
		assert (dims[0] > 1.0 and dims[1] > 1.0), "Invalid width or height for bounds."
		# //Set adjustment factor for width/height
		self.m_AdjustWidth = 1.0 / ((dims[0] - 1.0) * 0.5)
		self.m_AdjustHeight = 1.0 / ((dims[1] - 1.0) * 0.5)
	...
	def drag (self, NewPt):
		...
		return Matrix3fSetRotationFromQuat4f(NewRot)
