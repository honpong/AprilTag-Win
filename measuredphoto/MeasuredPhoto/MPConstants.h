...
#define CACHED_PHOTO_URL [CACHE_DIRECTORY_URL URLByAppendingPathComponent:@"photo.jpg"]
#define DEPTH_JSON_URL [DOCUMENTS_DIRECTORY_URL URLByAppendingPathComponent:@"depth.json"]
