...
__all__ = ('ConfigError', 'FileError', 'ImmutableAttribute',
           ...
           'UnsupportedResourceError', 'UploadError', 'ArgumentOperationError')
...
class ArgumentOperationError(_Error):
    def __init__(self, message='The operation is not supported because some of the arguments are invalids'):
