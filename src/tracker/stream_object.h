...
public:
    ...
    /// callback function upon receipt of stage poses.
    std::function<void(const rc_Stage*, rc_Timestamp)> stage_callback{ nullptr };
    /// callback function upon receipt of relocalization event
    std::function<void(const rc_Relocalization*)> relocalization_callback{ nullptr };
...
public:
    ...
    rc_RelocalizationCallback relocalization_callback{ nullptr };
    void * message_handle { nullptr };
    rc_StatusCallback status_callback{ nullptr };
    void *map_load_handle{ nullptr }, *save_handle{ nullptr }, *pose_handle{ nullptr }, *out_handle{ nullptr };
